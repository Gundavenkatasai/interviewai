...
const adapters = ['cutshort.adapter.ts', 'hirist.adapter.ts', 'shine.adapter.ts', 'timesjobs.adapter.ts', 'wellfound.adapter.ts'];
...
for (const file of adapters) {
  ...
  content = content.replace(/errorRate: 0/g, 'errorRate: 100,\n      restriction: "External Limitation: Site DOM structure is heavily obfuscated/protected. Requires manual reverse-engineering of selectors."');
